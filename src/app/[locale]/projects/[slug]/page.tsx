        ...
        <div className="flex flex-col gap-16 w-full items-center">
          ...
          {project.sections.map((section, index) => {
            switch (section.type) {
              ...
              case "button":
                return (
                  // max-w-[900px] и mx-auto выравнивают кнопку по левому краю текста статьи
                  <div key={index} className="w-full max-w-[900px] mx-auto my-6 flex justify-start">
                    <ArticleButton
                      label={section.content.label}
                      url={section.content.url}
                      primary={section.content.primary}
                    />
                  </div>
                );
