  ...
  return (
    <section className="relative w-full h-[100dvh] flex flex-col items-center bg-white overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 pt-[15dvh] md:pt-[20dvh] w-full">
        <h1 className="text-[32px] md:text-[40px] font-semibold text-[#222222] font-['Unbounded'] leading-[1.2] tracking-[-0.01em] max-w-[800px]">
          {content.title}
        </h1>
        <p className="text-[20px] md:text-[20px] text-[#222222] mt-7 font-normal font-['Unbounded'] tracking-[-0.01em]">
          {content.subtitle}
        </p>
      ...
      {/* БЛОК СОЦИАЛЬНЫХ СЕТЕЙ (Внизу по центру Hero) */}
      <div className="absolute bottom-6 md:bottom-5 left-1/2 -translate-x-1/2 z-30 flex items-center gap-3 pointer-events-auto">
        <a
          href="https://t.me/liverans"
          target="_blank"
          rel="noopener noreferrer"
          className="w-[48px] h-[48px] md:w-[48px] md:h-[48px] rounded-full bg-[#F7F7FA]/90 backdrop-blur-sm hover:bg-white flex items-center justify-center transition-all shadow-md hover:scale-105"
          aria-label="Telegram"
        >
          <div className="w-5 h-5 md:w-6 md:h-6 bg-[#FF0033] [mask-image:url(/telegram_logo.svg)] [mask-size:contain] [mask-repeat:no-repeat] [mask-position:center]" />
        </a>
        <a
          ...
          aria-label="LinkedIn"
        >
          <div className="w-5 h-5 md:w-5 md:h-5 bg-[#FF0033] [mask-image:url(/linkedin_logo.svg)] [mask-size:contain] [mask-repeat:no-repeat] [mask-position:center]" />
        </a>
        <a
        ...
        >
          <div className="w-5 h-5 md:w-5 md:h-5 bg-[#FF0033] [mask-image:url(/x_logo.svg)] [mask-size:contain] [mask-repeat:no-repeat] [mask-position:center]" />
        </a>
      </div>
    </section>
  );
